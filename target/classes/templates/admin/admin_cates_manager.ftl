  ...
  <div class="content-wrapper" id="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">${category.categoryName!"null"}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row" style="margin-bottom: 20px">
          <div class="col-md-4">
            <select class="custom-select" id="myselect">
              ...
              <option value="2" id="opt2">新增</option>
              <option>移动</option>
...
<script src="/static/back/plugins/bs-custom-file-input/bs-custom-file-input.min.js"></script>
<script>
    /*根据链接中类型改变下拉框*/
