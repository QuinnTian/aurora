                ...
                <table class="table">
                  ...
                  <tbody>
                    <#list articles as art >
                        <tr>
                          <td>${art.articleTitle!"null"}</td>
                          <td><#if art.categories??><#list art.categories as cc>${(cc.categoryName)!"null"}</#list></#if></td>
                          <td><#if art.tags??><#list art.tags as tt>${(tt.tagName)!"null"}</#list></#if></td>
                          <td><#if art.articlePostDate??>${(art.articlePostDate?datetime)}</#if></td>
