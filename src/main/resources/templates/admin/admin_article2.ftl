    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <!-- 内容标题-->
            <h1 class="m-0" style="display: inline;">文章管理</h1>
            <button class="btn btn-primary btn-xs" style="display: inline-block" onclick="location.href='/admin/tag/tagEdit'">新增文章</button>
              ...
              <div class="card-body">
                <table class="table">
                  ...
                  <tr>
                    ...
                    <td style="width:40%">${a.articleTitle!""}</td>
                    <td style="width: 20%"><#if a.categories??><#list a.categories as ac>#${ac.categoryName!"null"}</#list></#if></td>
                    <td style="width: 20%">
                      <#if a.tags??><#list a.tags as att>#${att.tagName!"null"}</#list></#if>
                    </td>
                    <td style="width: 20%">
                      <div class="row">
                        <div class="col-sm-4">
                          <button type="button" class="btn btn-block btn-info btn-xs" onclick="location.href='/admin/article/articleEditor?type=1&article=${a.id!""}'">编辑</button>

                        </div>
                        <div class="col-sm-4">
                          <button type="button" class="btn btn-block btn-warning btn-xs" onclick="location.href=''">查看</button>
