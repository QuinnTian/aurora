    ...
    <section class="content">
      ...
      <!-- 自定义内容-->
        <div class="row" style="margin-bottom: 10px">
          ...
          <div class="col-sm-4">
            <button type="button" class="btn btn-warning" id="commonbtn">批量删除</button>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
...
<#--<script src="/static/back/dist/js/pages/dashboard2.js"></script>-->
  ...
  if (nowhref.indexOf(type2)!=-1){
    ...
    $("#commonbtn").click(function () {
      ...
      $.post("/admin/tag/addArticlesToTag", { "articleIds":newTagIds.toString(),"tagId":${tag.id!"null"}},function(data,status){
  ...
  $('#myselect').change(function () {
    ...
    if (type == 1){
      window.location.href="/admin/tag/manager?type=1&tag="+${tag.id!"null"};

    }else if (type == 2){
      window.location.href="/admin/tag/manager?type=2&tag="+${tag.id!"null"};
